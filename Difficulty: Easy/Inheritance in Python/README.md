<h2><a href="https://www.geeksforgeeks.org/problems/inheritance-in-python/1?page=1&category=python&status=unsolved&sortBy=submissions">Inheritance in Python</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Implement the following classes to understand inheritance in Python:</span></p>
<ul>
